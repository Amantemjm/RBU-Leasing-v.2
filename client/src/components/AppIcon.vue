<script setup>
// Small feather-style icon set for the sidebar nav (stroke = currentColor).
...
const PATHS = {
  ...
  building: ["M3 21h18", "M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16", "M9 7h1", "M9 11h1", "M14 7h1", "M14 11h1", "M9 21v-4h6v4"],
